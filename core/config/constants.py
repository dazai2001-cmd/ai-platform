...
DEFAULT_CLOUD_TASK_MODEL_MAP = {
    TASK_RAG: MODEL_GEMINI_FLASH,
    TASK_BI: MODEL_GEMINI_FLASH,
    TASK_MEMORY: MODEL_GEMINI_FLASH,
    TASK_GENERAL: MODEL_GEMINI_FLASH,
    TASK_CAREER: MODEL_GEMINI_FLASH,
}
